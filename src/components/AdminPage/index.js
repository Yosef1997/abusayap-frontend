...
import InputAmountAdmin from '../AdminAmount'
          ...
          <Row>
            <Col md={3} style={{ minHeight: '80vh' }}>
              <Card bg="light" className="card-menu pt-2 border-0 shadow-sm" id="sidebar" style={{ height: '100%', minHeight: '350px' }}>
                <ul>
                  ...
                  <li>
                    <Link to="/Admin/contact" className="text-menu">
                  ...
                  <li>
                    <Link to="/Admin/topup" className="text-menu">
                  ...
                  <li>
                    <Link to="/Admin/profile" className="text-menu">
            ...
            <Col>
              <Switch>
                ...
                <Route exact path="/Admin/contact/input-amount">
                  <InputAmount />
                </Route>
                <Route exact path="/Admin/detail-transfer">
                  <DetailTransaction />
                </Route>
                <Route path="/Admin/contact/input-amount/detail-transfer/result-transaction">
                  <Result />
                </Route>
                ...
                <Route exact path="/Admin/profile/personal-info">
                  <PersonalInfo />
                </Route>
                ...
                <Route path="/Admin/profile/change-pin">
                  <ChangePin />
                </Route>
                <Route exact path="/Admin/profile/personal-info/manage-phone-number">
                  <ManagePhoneNumber />
                </Route>
                <Route path="/Admin/profile/personal-info/manage-phone-number/add-phone-number">
                  <AddPhoneNumber />
                </Route>
              </Switch>
            </Col>
